...
<body>
	...
	<s:form>
		...
		<s:textfield label="Twitter account"
			name="processVariables['twitterAccount']"
			value="%{#processVariables['twitterAccount']}" id="twitterAccount" />
		<s:textarea label="Tweet content"
			name="processVariables['tweetContent']"
			value="%{#processVariables['tweetContent']}" id="tweetContent"
			maxlength="140" cols="50" rows="4" />
		<s:submit />
	</s:form>
</body>
</html>
